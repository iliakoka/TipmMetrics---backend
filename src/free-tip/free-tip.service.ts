  ...
  async getFreeTip() {
    ...
    if (freeTip) {
      ...
      return {
        ...
        homeTeam: freeTip.homeTeamName,
        awayTeam: freeTip.awayTeamName,
        homeTeamLogo: freeTip.homeTeamLogo || freeTip.fixture?.homeTeamLogo || null,
        awayTeamLogo: freeTip.awayTeamLogo || freeTip.fixture?.awayTeamLogo || null,
